  ...
  return (
    <div className="relative w-full h-10">
      <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
        <Icon className="size-4 text-yellow-900" />
      </div>
      <input
        {...props}
        className="w-full h-10 pl-10 pr-3 py-3 bg-white rounded-lg border focus:border-white focus:ring-1 focus:ring-white text-yellow-950 placeholder-black transition duration-200 font-normal text-sm"
      />
    </div>
  );
};
...
export const PasswordInput = ({ icon: Icon, ...props }) => {
  return (
    <div className="relative w-full h-10">
      <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
        <Icon className="size-4 text-yellow-950" />
      </div>
      <input
        {...props}
        className="w-full h-10 pl-10 pr-3 py-3 bg-white rounded-lg border focus:border-white focus:ring-1 focus:ring-white text-yellow-950 placeholder-black transition duration-200 font-normal text-sm"
