...
export default function DashProfile() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (imageFileUrl) changedFields.image = imageFileUrl;
...
//       <h1 className="sm:my-7 text-center font-semibold text-3xl text-black">
//         Profile
//       </h1>
//       <form onSubmit={handleSubmit} className="flex flex-col gap-4">
//         <input
...
//           Delete Account
//         </span>
//         <span onClick={confirmLogout} className="cursor-pointer">
//           Sign Out
//         </span>
//       </div>
//       {/* {updateUserSuccess && (
